...
public class Projeto implements AbstractProjeto {
    ...
    private String h_i;
    private String h_f;
    private User profPesq;
    private String status;
    private LinkedList<User> userProject = new LinkedList<User>();
    //Relatório projeto
    @Override
    public String toString(){
        return "Id do projeto:"+ this.id + "\nDescrição: " + this.descricao + "\nCoordenador: " + this.profPesq.name;
    }
    
    //Construtores
    public Projeto(String id, String descricao){
        this.id = id;
        this.descricao = descricao;
    }
    public Projeto(String id, String descricao, User coordenador){
        this.id = id;
        this.descricao = descricao;
        this.setProfPesq(coordenador);
    }
    public Projeto(){
    ...
    public User getProfPesq() {
        return profPesq;
    }
    public void setProfPesq(User profPesq) {
        this.profPesq = profPesq;
    }
